...
<html lang="en">
  ...
  <body class="p-3 mb-2 bg-light text-light">
    <div class="container mt-3 shadow-lg p-3 mb-5 bg-primary rounded">
        <h1 style="text-align:center;">Quiz 2 <br>( Login Form With Session Cookies )</h1>
        <br></br>
